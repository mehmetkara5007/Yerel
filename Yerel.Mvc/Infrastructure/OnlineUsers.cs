...
namespace Yerel.Mvc.Infrastructure
{
    public class OnlineUsers
    {
        ...
        private static readonly ConcurrentDictionary<string, Product> _apiDataList = new ConcurrentDictionary<string, Product>();
        ...
        public IEnumerable<Product> GetAllApiData()
        {
            //BroadcastApiCount();
        ...
        private void BroadcastApiData(Product data, ActionMethod method)
        {
            switch (method)
            {
        ...
        private void BroadcastSentDataApi(Product data, ActionMethod method)
        {
            switch (method)
            {
                case ActionMethod.Put:
        ...
        internal IEnumerable<Product> GetAllSentData()
        {
